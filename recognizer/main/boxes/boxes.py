...
def run_flow(image_path: str, threshold: int = 20, psm: int = 6, oem: int = 3) -> List[Tuple[int, int, int, int]]:
    """
...
def test_flow(input_image: str, params: dict, output_path: str) -> dict:
    """
    ...
    boxes = run_flow(input_image, threshold, psm, oem)
